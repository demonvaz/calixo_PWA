      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Inicia sesión para continuar tu viaje de desconexión digital
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link 
                  ...
                  className="text-sm text-soft-blue hover:underline"
                >
        ...
        <CardFooter className="flex flex-col space-y-4">
          <div className="text-sm text-center text-neutral-gray">
            ...
            <Link href="/auth/signup" className="text-soft-blue hover:underline font-medium">
              Regístrate gratis
            </Link>
          </div>
        </CardFooter>
